 ...
 *
 * Core vars (KORTIX_TOKEN, KORTIX_API_URL, INTERNAL_SERVICE_KEY,
 ...
 *
 * Older builds allowed KORTIX_TOKEN, INTERNAL_SERVICE_KEY, and TUNNEL_TOKEN
 * to drift apart. The refactored model uses one sandbox token for all three.
